...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writingTagFilters = new IntentFilter();
    }
    private NdefRecord readFromIntent (Intent intent) {
        ...
        private void buildTagViews (NdefMessage[]msgs)String text;
        {
...
//            String tagId = new String(msgs[0].getRecords ()[0].getType());
            ...
            try {
                ...
                log.e("UnsupportedEncodding", e.toString());
            }
        ...
        private NdefRecord createRecord (String text) throws UnsupportedEncodingException {
            ...
            System.arraycopy(langBytes, srcPos:0, payload, destPos:1, langLength);
            System.arraycopy(textBytes, srcPos:0, payload, destpos:1 + langLength, textLength);
        ...
        @Override
         protected void onNewIntent(Intent intent) {
            ...
            if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())){
                myTag = intent.getParcelableArrayExtra(NfcAdapter.EXTRA_TAG);
            }
        }
        @Override
        public void onPause(){
